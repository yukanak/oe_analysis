...
def calib_ba2():
        ...
        calib["R_WIRE"] = np.array([60.00]*16)    #ohms include in R_FB and R_BIAS
        ...
        calib["R_FB"] = np.array([2000.00]*16)
        ...
        calib["FB_CAL"] = (calib["V_FB_MAX"]/(2**calib["BITS_FB"]))/(calib["R_FB"]+calib["R_WIRE"])/calib["M_FB"]*1.2195122
        return calib
