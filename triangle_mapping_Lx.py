...
def triange_mapping_single_loss(data_array, itile, vmin,vmax,vari,unit,outpath, mask_wire = None, maintitle=' ', cmap = 'jet'):
	[x,y,triangles] = prepare_triangles(1)
	print(x,y,triangles)
	if not mask_wire:
		mask_wire = get_default_mask_loss()
		plot_a_map(data_array, triangles, x, y, mask_wire, itile, vmin, vmax, vari, unit, outpath, maintitle=maintitle, cmap = cmap)
